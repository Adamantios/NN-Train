...
def omniglot_complicated_ensemble_submodel3(input_shape=None, input_tensor=None, n_classes=None,
    ...
    x = Dropout(0.3, name='block1_dropout', seed=0)(x)
    ...
    x = Dropout(0.5, name='block2_dropout', seed=0)(x)
    ...
    # Create Submodel 1.
    model = Model(inputs, outputs, name='omniglot_complicated_ensemble_submodel3')
...
def omniglot_complicated_ensemble_submodel3_labels_manipulation(labels_array: ndarray) -> int:
    """
    ...
    """
    # Labels [649 - 973].
    labels_array[logical_or(labels_array < 649, labels_array > 973)] = -1

    for i, label_i in enumerate(range(649, 974)):
