...
def svhn_pyramid_ensemble_submodel_weak1(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Create Submodel 2.
    model = Model(inputs, outputs, name='svhn_pyramid_ensemble_submodel_weak1')
...
def svhn_pyramid_ensemble_submodel_weak1_labels_manipulation(labels_array: ndarray) -> int:
    """
