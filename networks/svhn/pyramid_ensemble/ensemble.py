...
def svhn_pyramid_ensemble(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Submodel Strong.
    # Block1.
    x1 = Conv2D(32, (3, 3), padding='same', activation='elu', name='submodel_strong_block1_conv1')(inputs)
    x1 = Conv2D(32, (3, 3), padding='same', activation='elu', name='submodel_strong_block1_conv2')(x1)
    x1 = MaxPooling2D(pool_size=(2, 2), name='submodel_strong_block1_pool')(x1)

    # Block2
    x1 = Conv2D(64, (3, 3), padding='same', activation='elu', name='submodel_strong_block2_conv1')(x1)
    x1 = Conv2D(64, (3, 3), padding='same', activation='elu', name='submodel_strong_block2_conv2')(x1)
    ...
    x1 = Conv2D(128, (3, 3), padding='same', activation='elu', name='submodel_strong_block3_conv')(x1)
    ...
    # Submodel Weak 1.
    # Block1.
    x2 = Conv2D(64, (3, 3), padding='same', activation='elu', name='submodel_weak_1_block1_conv1')(inputs)
    x2 = Conv2D(64, (3, 3), padding='same', activation='elu', name='submodel_weak_1_block1_conv2')(x2)
    ...
    averaged_first_half_classes = Average(name='averaged_first_half_classes')(
        [
            Crop(1, 0, 5)(outputs_submodel_strong),
            outputs2
        ]
    )
    ...
    # Submodel Weak 2.
    # Block1.
    x3 = Conv2D(64, (3, 3), padding='same', activation='elu', name='submodel_weak_2_block1_conv1')(inputs)
    x3 = Conv2D(64, (3, 3), padding='same', activation='elu', name='submodel_weak_2_block1_conv2')(x3)
    ...
    averaged_last_half_classes = Average(name='averaged_last_half_classes')(
        [
            Crop(1, 5, 10)(outputs_submodel_strong),
            outputs3
        ]
    )
    ...
    # Create model.
    model = Model(inputs, outputs, name='svhn_pyramid_ensemble')
