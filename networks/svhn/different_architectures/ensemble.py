...
def svhn_architectures_diverse_ensemble(input_shape=None, input_tensor=None, n_classes=None,
                                        weights_path: Union[None, str] = None) -> Model:
    """
    Defines a svhn_architectures_diverse_ensemble network.
    ...
    submodel_2 = svhn_model2(n_classes, input_shape, input_tensor, weights_path)
    submodel_3 = svhn_model3(n_classes, input_shape, input_tensor, weights_path)
    ...
    # Create model.
    model = Model(inputs, outputs, name='svhn_architectures_diverse_ensemble')
