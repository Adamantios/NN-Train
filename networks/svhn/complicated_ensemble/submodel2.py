...
def svhn_complicated_ensemble_submodel2(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Create Submodel 2.
    model = Model(inputs, outputs, name='svhn_complicated_ensemble_submodel2')
...
def svhn_complicated_ensemble_submodel2_labels_manipulation(labels_array: ndarray) -> int:
    """
