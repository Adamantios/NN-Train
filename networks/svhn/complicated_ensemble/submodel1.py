...
def svhn_complicated_ensemble_submodel1(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Create Submodel 1.
    model = Model(inputs, outputs, name='svhn_complicated_ensemble_submodel1')
...
def svhn_complicated_ensemble_submodel1_labels_manipulation(labels_array: ndarray) -> int:
    """
