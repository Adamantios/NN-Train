...
from tensorflow.python.keras.layers import Conv2D, MaxPooling2D, Dense, Flatten, BatchNormalization, Dropout
from tensorflow.python.keras.regularizers import l2

from networks.tools import load_weights, create_inputs


def caltech_model3(n_classes: int, input_shape=None, input_tensor=None,
    ...
    x = Conv2D(64, (3, 3), padding='same', activation='relu', input_shape=input_shape,
