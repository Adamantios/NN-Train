...
def caltech_pyramid_ensemble_submodel_weak1(input_shape=None, input_tensor=None, n_classes=None,
    ...
    model = Model(inputs, outputs, name='caltech_pyramid_ensemble_submodel_weak1')
...
def caltech_pyramid_ensemble_submodel_weak1_labels_manipulation(labels_array: ndarray) -> int:
    """
    ...
    """
    labels_array[labels_array > 61] = 61
    return 62
