...
def caltech_pyramid_ensemble_submodel_weak2(input_shape=None, input_tensor=None, n_classes=None,
    ...
    x = Conv2D(64, (5, 5), padding='same', activation='relu', input_shape=input_shape,
    ...
    model = Model(inputs, outputs, name='caltech_pyramid_ensemble_submodel_weak2')
...
def caltech_pyramid_ensemble_submodel_weak2_labels_manipulation(labels_array: ndarray) -> int:
    """
    ...
    """
    labels_array[labels_array < 61] = -1

    for i, label_i in enumerate(range(61, 102)):
        labels_array[labels_array == label_i] = i

    labels_array[labels_array == -1] = 61
