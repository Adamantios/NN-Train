...
def caltech_complicated_ensemble_submodel5(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Create Submodel 1.
    model = Model(inputs, outputs, name='caltech_complicated_ensemble_submodel5')
...
def caltech_complicated_ensemble_submodel5_labels_manipulation(labels_array: ndarray) -> int:
    """
    ...
    """
    labels_array[logical_or(labels_array < 82, labels_array > 101)] = -1

    for i, label_i in enumerate(range(82, 102)):
