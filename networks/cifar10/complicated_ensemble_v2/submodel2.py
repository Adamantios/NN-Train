...
def cifar10_complicated_ensemble_v2_submodel2(input_shape=None, input_tensor=None, n_classes=None,
    ...
    """
    model = cifar10_complicated_ensemble_submodel2(input_shape, input_tensor, n_classes, weights_path)
    model._name = 'cifar10_complicated_ensemble_v2_submodel2'
    return model


def cifar10_complicated_ensemble_v2_submodel2_labels_manipulation(labels_array: ndarray) -> int:
    """
