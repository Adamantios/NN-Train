...
def cifar10_pyramid_ensemble_submodel_strong(input_shape=None, input_tensor=None, n_classes=None,
    ...
    x1 = Conv2D(128, (3, 3), padding='same', activation='elu', name='block3_conv')(x1)
    x1 = Dropout(0.5, name='block3_dropout')(x1)

    # Add Submodel Strong top layers.
    x1 = Flatten(name='flatten')(x1)
    outputs = Dense(10, name='output')(x1)

    # Create Submodel 1.
    model = Model(inputs, outputs, name='cifar10_pyramid_ensemble_submodel_strong')
