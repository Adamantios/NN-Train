...
def cifar10_pyramid_ensemble_submodel_weak1(input_shape=None, input_tensor=None, n_classes=None,
...
def cifar10_pyramid_ensemble_submodel_weak1_labels_manipulation(labels_array: ndarray) -> int:
    """
