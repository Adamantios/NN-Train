...
def cifar10_complicated_ensemble_submodel5(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Block2
    x1 = Conv2D(32, (3, 3), padding='same', activation='elu', name='block2_conv1')(x1)
    x1 = Conv2D(32, (3, 3), padding='same', activation='elu', name='block2_conv2')(x1)
    ...
    # Create Submodel 1.
    model = Model(inputs, outputs, name='cifar10_complicated_ensemble_submodel5')
