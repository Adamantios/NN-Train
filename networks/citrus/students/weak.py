...
def citrus_student_weak(n_classes: int, input_shape=None, input_tensor=None,
    ...
    x = Conv2D(16, (2, 2), activation='relu', name='conv1', kernel_regularizer=l2(1e-4))(inputs)
    ...
    # Create weak student.
    model = Model(inputs, outputs, name='citrus_student_weak')
