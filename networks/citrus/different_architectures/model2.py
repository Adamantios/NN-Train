...
def citrus_model2(n_classes: int, input_shape=None, input_tensor=None,
    ...
    # Block1.
    x = Conv2D(16, (3, 3), padding='same', activation='elu', name='block1_conv1', kernel_regularizer=l2(weight_decay))(
        inputs)
    ...
    # Block2
    x = Conv2D(32, (3, 3), padding='same', activation='elu', name='block2_conv1', kernel_regularizer=l2(weight_decay))(
        x)
    ...
    # Create Submodel 1.
    model = Model(inputs, outputs, name='citrus_model2')
