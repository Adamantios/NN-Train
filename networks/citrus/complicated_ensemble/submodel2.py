...
def citrus_complicated_ensemble_submodel2(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Create Submodel 1.
    model = Model(inputs, outputs, name='citrus_complicated_ensemble_submodel2')
...
def citrus_complicated_ensemble_submodel2_labels_manipulation(labels_array: ndarray) -> int:
    """
