...
def citrus_pyramid_ensemble_submodel_strong(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Block1.
    x = Conv2D(16, (3, 3), activation='elu', name='block1_conv1', padding='same',
    ...
    # Block2
    x = Conv2D(32, (3, 3), activation='elu', name='block2_conv1', padding='same',
    ...
    model = Model(inputs, outputs, name='citrus_pyramid_ensemble_submodel_strong')
