...
def cifar100_complicated_ensemble_submodel2(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Block1.
    x = Conv2D(256, (3, 3), padding='same', activation='elu', name='block1_conv1')(inputs)
    x = Conv2D(256, (3, 3), padding='same', activation='elu', name='block1_conv2')(x)
    x = MaxPooling2D(pool_size=(2, 2), name='block1_pool')(x)

    # Block2
    x = Conv2D(512, (3, 3), padding='same', activation='elu', name='submodel2_block2_conv1')(x)
    x = Conv2D(512, (3, 3), padding='same', activation='elu', name='submodel2_block2_conv2')(x)
    x = MaxPooling2D(pool_size=(2, 2), name='submodel2_block2_pool')(x)
