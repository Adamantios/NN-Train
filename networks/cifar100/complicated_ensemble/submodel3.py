...
def cifar100_complicated_ensemble_submodel3(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Block1.
    x1 = Conv2D(128, (3, 3), padding='same', activation='elu', name='block1_conv1', kernel_regularizer=l2(weight_decay))(inputs)
    x1 = Conv2D(128, (3, 3), padding='same', activation='elu', name='block1_conv2', kernel_regularizer=l2(weight_decay))(x1)
    x1 = BatchNormalization(name='block1_batch-norm')(x1)
    x1 = MaxPooling2D(pool_size=(2, 2), name='block1_pool')(x1)

    # Block2
    x1 = Conv2D(256, (3, 3), padding='same', activation='elu', name='block2_conv1', kernel_regularizer=l2(weight_decay))(x1)
