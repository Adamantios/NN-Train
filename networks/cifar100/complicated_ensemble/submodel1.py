...
def cifar100_complicated_ensemble_submodel1(input_shape=None, input_tensor=None, n_classes=None,
    ...
    # Block 1.
    x = Conv2D(32, (3, 3), padding='same', activation='elu', name='block1_conv1', kernel_regularizer=l2(weight_decay))(
        inputs)
    x = BatchNormalization(name='block1_batch-norm1')(x)
    x = Conv2D(32, (3, 3), padding='same', activation='elu', name='block1_conv2', kernel_regularizer=l2(weight_decay))(
        x)
    ...
    # Block 2.
    x = Conv2D(64, (3, 3), padding='same', activation='elu', name='block2_conv1', kernel_regularizer=l2(weight_decay))(
        x)
    x = BatchNormalization(name='block2_batch-norm1')(x)
    x = Conv2D(64, (3, 3), padding='same', activation='elu', name='block2_conv2', kernel_regularizer=l2(weight_decay))(
        x)
    ...
    # Block 3.
    x = Conv2D(128, (3, 3), padding='same', activation='elu', name='block3_conv1', kernel_regularizer=l2(weight_decay))(
        x)
    x = BatchNormalization(name='block3_batch-norm1')(x)
    x = Conv2D(128, (3, 3), padding='same', activation='elu', name='block3_conv2', kernel_regularizer=l2(weight_decay))(
        x)
    ...
    # Block 4.
    x = Conv2D(256, (3, 3), padding='same', activation='elu', name='block4_conv1', kernel_regularizer=l2(weight_decay))(
        x)
    x = BatchNormalization(name='block4_batch-norm1')(x)
    x = Conv2D(256, (3, 3), padding='same', activation='elu', name='block4_conv2', kernel_regularizer=l2(weight_decay))(
        x)
    ...
    # Create Submodel 1.
    model = Model(inputs, outputs, name='cifar100_complicated_ensemble_submodel1')
...
def cifar100_complicated_ensemble_submodel1_labels_manipulation(labels_array: ndarray) -> int:
    """
    ...
    """
    labels_array[labels_array > 20] = 20
    return 21
