...
def cifar100_weak_ensemble(input_shape=None, input_tensor=None, n_classes=None,
                           weights_path: Union[None, str] = None) -> Model:
    """
    Defines a cifar100_weak_ensemble network.
    ...
    # Generate Submodels.
    submodel_1 = cifar100_student_weak(n_classes, input_shape, input_tensor, weights_path)
    submodel_2 = cifar100_student_weak(n_classes, input_shape, input_tensor, weights_path)
    submodel_3 = cifar100_student_weak(n_classes, input_shape, input_tensor, weights_path)
    ...
    # Create model.
    model = Model(inputs, outputs, name='cifar100_weak_ensemble')
